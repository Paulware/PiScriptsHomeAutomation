...
<?php 
  ...
  $sql = "CREATE TABLE sensors (ID INT AUTO_INCREMENT PRIMARY KEY, MAC char(255), Value char(255), Nickname char(255), TypeName char(255), Action INT DEFAULT 0, IpAddress char(255), Humidity char(255), Timestamp TIMESTAMP)";  
  $result = mysql_query ($sql);
